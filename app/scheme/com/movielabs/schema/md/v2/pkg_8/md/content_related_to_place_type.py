...
from  app.scheme.com.movielabs.schema.md.v2.pkg_8.md.coordinate_earth_type import (
    CoordinateEarthType,
)
from  app.scheme.com.movielabs.schema.md.v2.pkg_8.md.coordinate_other_type import (
    CoordinateOtherType,
)
