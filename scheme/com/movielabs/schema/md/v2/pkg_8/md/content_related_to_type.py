...
from scheme.com.movielabs.schema.md.v2.pkg_8.md.content_related_to_character_type import (
    ContentRelatedToCharacterType,
)
from scheme.com.movielabs.schema.md.v2.pkg_8.md.content_related_to_event_type import (
    ContentRelatedToEventType,
)
from scheme.com.movielabs.schema.md.v2.pkg_8.md.content_related_to_period_type import (
    ContentRelatedToPeriodType,
)
from scheme.com.movielabs.schema.md.v2.pkg_8.md.content_related_to_person_type import (
    ContentRelatedToPersonType,
)
from scheme.com.movielabs.schema.md.v2.pkg_8.md.content_related_to_place_type import (
    ContentRelatedToPlaceType,
)
from scheme.com.movielabs.schema.md.v2.pkg_8.md.content_related_to_relationship_type import (
    ContentRelatedToRelationshipType,
)
from scheme.com.movielabs.schema.md.v2.pkg_8.md.content_related_to_work_type import (
